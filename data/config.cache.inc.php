...
$cfg_basehost = 'http://www.akawei.local';
$cfg_cmspath = '';
$cfg_cookie_encode = 'esRPmaBOgvDfDh3yVv1ksGrsKlnbxbo';
$cfg_indexurl = '/';
$cfg_backup_dir = 'backupdata';
$cfg_indexname = '主页';
$cfg_webname = '阿卡维科技有限公司 Akawei Technology Co., Ltd.';
$cfg_adminemail = 'heacheuy@live.cn';
...
$cfg_multi_site = 'N';
$cfg_dede_log = 'N';
$cfg_powerby = 'Copyright &copy; 2017 Akawei. 阿卡维科技 版权所有';
$cfg_arcsptitle = 'N';
$cfg_arcautosp = 'N';
...
$cfg_rewrite = 'N';
$cfg_delete = 'Y';
$cfg_keywords = '阿卡维科技网站策划,四川成都网站设计,成都电商平台策划开发,成都品牌网站设计制作,成都高端企业品牌网站设计,网页应用开发,成都APP开发,成都手机应用开发,四川成都AR应用研发,成都AR开发';
$cfg_description = '阿卡维科技有限公司，主营：移动互联网、Ipad地产销控营销展示、Ipad地产楼书、IPAD电子楼书、虚拟现实、网页设计、网站开发、微信公众平台设计开发、相关app开发等';
$cfg_beian = '';
$cfg_need_typeid2 = 'Y';
$cfg_cache_type = 'id';
$cfg_max_face = 50;
